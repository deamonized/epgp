...
L["%+d EP (%s) to %s"] = true
L["%+d EP by %s (%s) to %s"] = true
L["%+d GP (%s) to %s"] = true
L["%+d GP by %s (%s) to %s"] = true
L["%d EP, %d GP by %s (%s) to: %s"] = true
L["%d or %d"] = true
L["%s decayed"] = true
...
L["%s to %s"] = true
L["(corrupt/malformed log entry)"] = true
L["Alts"] = true
